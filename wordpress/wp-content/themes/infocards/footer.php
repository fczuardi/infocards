...
?>
    ...
    <div class="abas">
	  ...
	  <div class="top">
	    <ul class="adr">
	      <li>Endereço: <span class="street-address"><a href="http://g.co/maps/vfn9z" target="_blank">Av. São Gabriel, 495 1º Andar</a></span> - <span class="locality">São Paulo</span> - <span class="region">SP</span></li>
	      <li>|</li>
